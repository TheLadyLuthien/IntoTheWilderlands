...
public interface SimpleInventory extends Inventory
{
     ...
     * @param count How many items to remove. If there are less items in the slot than what are
     ...
     *        ({@link Inventory#getMaxCountPerStack()}), it gets resized to this inventory's maximum
     *        amount.
     */
    @Override
    ...
    /**
     * Marks the state as dirty. Must be called after changes in the inventory, so that the game can
     * properly save the inventory contents and notify neighboring blocks of inventory changes.
     */
    @Override
